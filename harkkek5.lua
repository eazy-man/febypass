	-- topkek 5.0 clone (reskinned topkek v4) for the 2016 client made in 11pm in the night
	function rgb(r,g,b) return Color3.new(r/255,g/255,b/255) end
	local topkek = {}
	...
	topkek.misc = {}
	if game.CoreGui:FindFirstChild("5.0") then
		game.CoreGui["5.0"]:Remove()
	end
	local NewGuiPart1 = Instance.new("ScreenGui", game.CoreGui)
	NewGuiPart1.Name = "5.0"
	-------
	local NewGuiPart2 = Instance.new("Frame")
	NewGuiPart2.Active = true
	NewGuiPart2.BackgroundColor3 = rgb(79, 108, 204)
	NewGuiPart2.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart3.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart4.Font = Enum.Font.SourceSansBold
	NewGuiPart4.FontSize = Enum.FontSize.Size28
	NewGuiPart4.Text = "T0PK3K 5.0"
	...
	NewGuiPart14.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart15.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart16.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart18.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart19.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart20.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart21.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart22.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart23.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart24.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart25.BackgroundColor3 = rgb(79, 108, 204)
	...
	NewGuiPart27.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart29.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart30.BackgroundColor3 = rgb(55, 70, 204)
	...
	NewGuiPart31.BackgroundColor3 = rgb(55, 70, 204)
	...
	wait(1)
	topkek.center = NewGuiPart1.Main
	topkek.holder = NewGuiPart1.Main.Holder
	topkek.topbar = NewGuiPart1.Main.Topbar
	topkek.template = NewGuiPart1.Main.Holder.Template
	topkek.navigator = NewGuiPart1.Main.Holder.Navigator
	...
	GUI = {
		...
		DropDown = {
			...
			Color = {
				Main = color3(79, 108, 204);
				Secondary = color3(55, 70, 204);
				Border = color3(36, 65, 191);
				Text = rgb(199,199,199);
			};
			New = function(Position, Size, Parent, ...)
				local vValue = {};
	...
	function topkek.tools.util.getContainer(n)
		if NewGuiPart1.Main.Holder:FindFirstChild(n) then
			return  NewGuiPart1.Main.Holder[n]
		else
	...
	function topkek.tools.gui:hookContainer(o, ncan, sepr, stt)
		...
		function self:drawButton(sz, txt, func, ysz, cbgd)
			...
			local obj = topkek.tools.util.Object("TextButton", {
				Parent = self.main;
				BackgroundColor3 = cbgd or Color3.new(55/255, 70/255, 204/255);
				BorderSizePixel = 0;
		...
		function self:drawText(sz, txt, ysz)
			...
			local obj = topkek.tools.util.Object("TextLabel", {
				Parent = self.main;
				BackgroundColor3 = Color3.new(55/255, 70/255, 204/255);
				BorderSizePixel = 0;
				Position = UDim2.new(xposScale, xposOffset, 0, self.drawY);
				Size = UDim2.new(xszScale, xszOffset, 0, ysz);
				Font = 'SourceSans';
	...
	topkek.tools.animator.initialAnimation = function()
		...
		local topnav = NewGuiPart1.Main.Navigation.Topbar
		local topbar = topkek.topbar
		local pname =  NewGuiPart1.Main.Topbar.PlayerName:Clone()
		local solid = NewGuiPart1.Solid
		topkek.center.Size = UDim2.new(0, 150, 0, 30)
		NewGuiPart1.Composite1:TweenPosition(UDim2.new(0.5, -50, 0.5, -50), 'Out', 'Quad', 0.5)
		NewGuiPart1.Composite2:TweenPosition(UDim2.new(0.5, 0, 0.5, -50), 'Out', 'Quad', 0.5)
		wait(0.52)
		solid.Visible = true
		NewGuiPart1.Composite1:Destroy()
		NewGuiPart1.Composite2:Destroy()
		wait(3)
	...
	topkek.navigation.buildNavigator = function()
		local nav = NewGuiPart1.Main.Navigation
	...
	topkek.navigation.initCommandBar = function()
		...
		wait()
		local function ConChar(plr)
local desc = game:GetService("Players"):GetHumanoidDescriptionFromUserId(plr)
local newchar = game:GetService("Players"):CreateHumanoidModelFromDescription(desc,Enum.HumanoidRigType.R15)
...
newchar.Parent = workspace
	...
	topkek.navigation.buildHomePage = function()
		...
		hook:drawText(1, 'T0PK3K 5.0 SS Edition')
		...
		hook:drawText(1, 'Created by nosyliam', 55)
	end
	...
	local exBtn = exewin:drawButton(1, 'Execute', function()
		warn("this is literally just for show lmao")
	...
	plrwin:addSpacing()
	plrwin:drawButton(1/2, 'Jiggle Male', function()
		local hint = Instance.new("Hint", game.Workspace) 
		hint.Text = "You have been caught in 4K my guy"
		wait(3)
		hint:Destroy()
		topkek.lplr:Kick()
	end)
	plrwin:drawButton(1/2, 'Jiggle Female', function()
		local hint = Instance.new("Hint", game.Workspace) 
		hint.Text = "You have been caught in 4K my guy"
		wait(3)
		hint:Destroy()
	...
	teamInp = lpwin:drawTextBox(2/3, 'Bright blue')
	...
	lpwin:drawButton(1/2, 'Fedora', function()
		...
		game:GetObjects("rbxassetid://" .. tostring(Gear[math.random(1,#Gear)]))[1].Parent = topkek.lplr.Character
	end)
	...
	scriptwin:addSpacing()
	local scripts = game:GetObjects("rbxassetid://376553985")[1] --// T0PK3K Data
	local scripts2 = game:GetObjects("rbxassetid://364328150")[1].ScriptData --// Ro-Xploit Data
	local scripts3 = game:GetObjects("rbxassetid://709030527")[1].Scripts --// Nebula Hub Data
	local container = {}
	function MakeList(condition)
		...
		for i, v in pairs(scripts2:GetChildren()) do
			if string.find(v.Name:lower(), condition:lower()) or (condition == "") or (condition == " ") then
				local scr = scriptwin:drawButton(1, v.Name, function()
					spawn(function() loadstring(string.reverse(v.Source))() end)
				end, 25)
				scr.Name = 'Script'
			end
		end
		for i, v in pairs(scripts3:GetChildren()) do
			if string.find(v.Name:lower(), condition:lower()) or (condition == "") or (condition == " ") then
				local scr = scriptwin:drawButton(1, v.Name, function()
					spawn(function() loadstring(v.Source)() end)
				end, 25)
	...
	local decs = {
		...
		{'DaNk', '18884039197'},
		{'Robbie', '574773630'},
		{'Troll Face', '8126977748'},
		{'Jeff', '109129888'},
		{'Shrek', '170539018'},
		{'Doge', '133720697'},
		{'Dat Boi', '409578848'},
		{'RCCService', '138985830140389'},
		{'Santa Cat', '49497630'},
		{'Orange Helmet Cat', '5441921'},
		{'Sherlock Squirrel', '11853994'},
		{'Scary Face', '83046327'},
	}
	...
	local Gear={	
		{name='Korblox Mage Staff',id=127506105},
		{name='Historic Timmy Gun',id=116693764},
		{name='Rainbow Magic Carpet',id=225921000},
		{name='Gravity Coil',id=16688968},
		{name='Ban Hammer',id=10468797},
		{name='Subspace Tripmine',id=11999247}
	}
